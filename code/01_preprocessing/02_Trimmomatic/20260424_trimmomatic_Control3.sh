...
#SBATCH -c 1
#SBATCH -t 00:30:00
#SBATCH -J control_3_trimmomatic_RN
...
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Control_3_f1.fq.gz \
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Control_3_r2.fq.gz \
$output_dir/Control_3_f_paired.fq.gz \
$output_dir/Control_3_f_unpaired.fq.gz \
$output_dir/Control_3_r_paired.fq.gz \
$output_dir/Control_3_r_unpaired.fq.gz \
