...
#SBATCH -c 1
#SBATCH -t 00:30:00
#SBATCH -J heat_2_trimmomatic_RN
...
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Heat_treated_42_12h_2_f1.fq.gz \
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Heat_treated_42_12h_2_r2.fq.gz \
$output_dir/Heat_2_f_paired.fq.gz \
$output_dir/Heat_2_f_unpaired.fq.gz \
$output_dir/heat_2_r_paired.fq.gz \
$output_dir/Heat_2_r_unpaired.fq.gz \
