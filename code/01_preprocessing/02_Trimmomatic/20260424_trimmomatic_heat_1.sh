...
#SBATCH -c 1
#SBATCH -t 00:30:00
#SBATCH -J heat_1_trimmomatic_RN
...
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Heat_treated_42_12h_1_f1.fq.gz \
/crex/proj/uppmax2026-1-61/Genome_Analysis/2_Zhou_2023/reads/transcriptomic_data/Heat_treated_42_12h_1_r2.fq.gz \
$output_dir/Heat_1_f_paired.fq.gz \
$output_dir/Heat_1_f_unpaired.fq.gz \
$output_dir/heat_1_r_paired.fq.gz \
$output_dir/Heat_1_r_unpaired.fq.gz \
